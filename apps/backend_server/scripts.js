...
async function ScraperMain(imageUrl) {
  ...
  const lensResults =
    (_a = scraperResponse === null || scraperResponse === void 0 ? void 0 : scraperResponse.lens_results) === null ||
    _a === void 0
      ? void 0
      : _a.slice(0, 8);
  const pureLinks = lensResults === null || lensResults === void 0 ? void 0 : lensResults.map((item) => item.link);
  const batches = splitIntoBatches({
    array: pureLinks !== null && pureLinks !== void 0 ? pureLinks : [],
    batchSize: 3,
  });
  ...
  aiResults.forEach((item, index) => {
    var _a, _b;
    item['image_url'] =
      ((_a = lensResults === null || lensResults === void 0 ? void 0 : lensResults[index]) === null || _a === void 0
        ? void 0
        : _a.thumbnail) || '';
    item['title'] =
      ((_b = lensResults === null || lensResults === void 0 ? void 0 : lensResults[index]) === null || _b === void 0
        ? void 0
        : _b.title) || '';
  });
  aiResults.sort((a, b) => {
